...
TARGETS = sr sw psr psw qsr qsw \
		private-anonymous-mapping shared-anonymous-mapping distributed-shared-anonymous-mapping distributed-shared-anonymous-mapping-manypg-1g distributed-shared-anonymous-mapping-manypg-8g
OBJDUMPS =
